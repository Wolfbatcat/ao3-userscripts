...
function injectCompletionCheckboxes() {
    ...
    if (!complete || !ongoing) {
        // Find where to insert: after the notes field or at the end of the form
        let notesElem = document.getElementById('bookmark_search_with_notes');
        let insertAfter = notesElem && notesElem.closest('li') ? notesElem.closest('li') : filterForm.querySelector('li:last-child');
