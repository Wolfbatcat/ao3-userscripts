...
.userstuff h3 {
    ...
    function showFormatterMenu() {
        ...
        const removeIndentation = window.AO3MenuHelpers.createCheckbox({
            ...
            tooltip:
                "Remove manual indentation (non-breaking spaces) added at the start of paragraphs by some authors.",
        });
        ...
        const applyCodeFontSizeDates = window.AO3MenuHelpers.createCheckbox({
            ...
            tooltip:
                "Applies the Code Font Size setting to date elements. Requires a code font size to be specified above.",
        });
        ...
        const accentTooltip = window.AO3MenuHelpers.createTooltip("Skins wizard accent color");
        ...
        // Reset Link
        const resetLink = window.AO3MenuHelpers.createResetLink("Reset to Default Settings", () => {
        ...
        dialog.querySelector("#formatter-save").addEventListener("click", () => {
            ...
            FORMATTER_CONFIG.headerColor = window.AO3MenuHelpers.getValue("sw_headercolor") || "";
            FORMATTER_CONFIG.accentColor = window.AO3MenuHelpers.getValue("sw_accent_color") || "";
