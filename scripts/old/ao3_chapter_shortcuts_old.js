...
(function () {
    ...
    function showChapterShortcutsMenu() {
        ...
        separator.style.cssText = "margin: 10px 0; border: none; border-top: 1px solid inherit;";
        ...
        const presetButtons = presetSymbols.map((symbol) => {
            ...
            btn.style.cssText = "font-family: inherit; font-size: inherit; color: inherit;";
            return btn;
        });
            ...
            mutations.forEach((mutation) => {
                mutation.addedNodes.forEach((node) => {
                    if (node.nodeType === 1) {
                        ...
                        const bottomNav =
                            node.querySelector && node.querySelector('ul.actions a[href="#main"]')
                                ? node.querySelector("ul.actions")
                                : node.matches && node.matches('ul.actions a[href="#main"]')
                                  ? node
                                  : null;
                        if (bottomNav) {
                            ...
                            if (
                                ...
                                if (topLink) {
                                    ...
                                    if (hasPrev) {
                                        ...
                                        firstChapterBtnBottom.addEventListener(
                                            "click",
                                            function () {
                                                window.location.href = `/works/${getStoryId()}`;
                                            },
                                    ...
                                    if (hasNext) {
                                        ...
                                        const firstBtn = bottomNav.querySelector(
                                            "#go_to_first_chap_bottom",
                                        );
                                        if (firstBtn) {
