    ...
    dialog.innerHTML = `
      ...
      <div class="settings-section">
        ...
        <div class="two-column">
          <div class="setting-group">
            ...
            <input type="text" id="site-fontfamily-input" value="${FORMATTER_CONFIG.siteFontFamily}" placeholder="Arial, sans-serif">
          </div>
      ...
      <div class="settings-section">
        ...
        <div class="setting-group">
          ...
          <input type="text" id="paragraph-fontfamily-input" value="${FORMATTER_CONFIG.paragraphFontFamily}" placeholder="Arial, sans-serif">
        </div>
      ...
      <div class="settings-section">
        ...
        <div class="two-column">
          <div class="setting-group">
            ...
            <input type="text" id="header-fontfamily-input" value="${FORMATTER_CONFIG.headerFontFamily}" placeholder="Arial, sans-serif">
          </div>
        ...
        <div class="two-column">
          <div class="setting-group">
            ...
            <input type="text" id="code-fontfamily-input" value="${FORMATTER_CONFIG.codeFontFamily}" placeholder="'Courier New', monospace">
          </div>
