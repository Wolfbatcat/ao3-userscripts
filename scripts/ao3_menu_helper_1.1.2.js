...
(function () {
  ...
  const ThemeDetector = {
    ...
    getBlurbStyles() {
      ...
      if (!styles || styles.backgroundColor === 'rgba(0, 0, 0, 0)') {
        styles = this._getComputedStyle(null, { tag: 'li', className: 'blurb' });
      }
    ...
    getButtonStyles() {
      ...
      if (!styles || styles.backgroundColor === 'rgba(0, 0, 0, 0)') {
        styles = this._getComputedStyle(null, { tag: 'input', className: 'submit' });
      }
    ...
    getInputStyles() {
      ...
      const styles = this._getComputedStyle(null, { tag: 'input', className: 'text' });
    ...
    getFieldsetStyles() {
      ...
      if (!styles || styles.backgroundColor === 'rgba(0, 0, 0, 0)') {
        styles = this._getComputedStyle(null, { tag: 'fieldset', className: '' });
      }
  ...
  window.AO3MenuHelpers = {
    ...
    createListItem(config) {
      ...
      item.style.cssText = `
            ...
            margin: 8px 0;
            background: ${blurbTheme.backgroundColor};
            border: ${blurbTheme.borderWidth} solid ${blurbTheme.borderColor};
            border-radius: ${blurbTheme.borderRadius};
            box-shadow: ${blurbTheme.boxShadow};
            cursor: pointer;
            display: flex;
            justify-content: space-between;
            align-items: center;
