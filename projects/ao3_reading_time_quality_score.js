...
// @namespace   https://github.com/BlackBatCat/ao3-userscripts
// @author      BlackBatCat
// @version     1.1
...
(function () {
  ...
  const addCombinedMenu = () => {
    ...
    if (
      ...
      // Fallback: create own menu
      const headerMenu = $1("ul.primary.navigation.actions");
      const searchItem = $1("li.search", headerMenu);
      if (!headerMenu || !searchItem) return;

      const combinedMenu = document.createElement("li");
      combinedMenu.className = "dropdown";
      combinedMenu.innerHTML = "<a>Reading & Score</a>";
      headerMenu.insertBefore(combinedMenu, searchItem);

      const dropMenu = document.createElement("ul");
      dropMenu.className = "menu dropdown-menu";
      combinedMenu.appendChild(dropMenu);
      ...
      addMenuItem("Reading & Quality Settings", showSettingsPopup);
    }
  };
